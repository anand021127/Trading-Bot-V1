...
const ALL_TESTS = [
  ...
  { name: 'historical_data', label: 'Underlying History', desc: 'Fetch real index-underlying candles from Upstox' },
  { name: 'live_quote', label: 'Underlying Quote', desc: 'Get current LTP for supported index underlyings' },
  { name: 'websocket', label: 'WebSocket Feed', desc: 'Connect to Upstox WebSocket and receive a price tick' },
  { name: 'place_order_paper', label: 'Place Option Order (Paper)', desc: 'Simulate a broker-resolved option order — no real money' },
